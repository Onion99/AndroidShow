package com.onion.android.java.core.text;

import com.onion.android.java.core.util.ArrayUtil;
import com.onion.android.java.core.util.StringUtil;
		...
		for (int argIndex = 0; argIndex < argArray.length; argIndex++) {
			...
			if (delimIndex > 0 && strPattern.charAt(delimIndex - 1) == StringUtil.C_BACKSLASH) {// 转义符
				if (delimIndex > 1 && strPattern.charAt(delimIndex - 2) == StringUtil.C_BACKSLASH) {// 双转义符
					...
					sbuf.append(StringUtil.object2String(argArray[argIndex], StandardCharsets.UTF_8));
