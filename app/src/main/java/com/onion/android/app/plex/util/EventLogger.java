 ...
 */
public class EventLogger implements AnalyticsListener, MediaSourceEventListener, MetadataOutput {
    ...
    @Override
    public void onBandwidthEstimate(final EventTime eventTime, final int totalLoadTimeMs, final long totalBytesLoaded, final long bitrateEstimate) {
