...
public class SeriesGenreListDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    private final SeriesGenresListDataSourceFactory moviesGenresListDataSourceFactory;
    private final SettingsManager settingsManager;

    public SeriesGenreListDataSource(String genreId, SeriesGenresListDataSourceFactory seriesGenresListDataSourceFactory, SettingsManager settingsManager){

        this.moviesGenresListDataSourceFactory = seriesGenresListDataSourceFactory;
