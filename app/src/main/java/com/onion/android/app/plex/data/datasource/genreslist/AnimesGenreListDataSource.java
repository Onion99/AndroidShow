...
public class AnimesGenreListDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    private final AnimesGenresListDataSourceFactory animesGenresListDataSourceFactory;
    private final SettingsManager settingsManager;

    public AnimesGenreListDataSource(String genreId, AnimesGenresListDataSourceFactory animesGenresListDataSourceFactory,SettingsManager settingsManager){

        this.animesGenresListDataSourceFactory = animesGenresListDataSourceFactory;
