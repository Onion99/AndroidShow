...
public class MoviesGenreListDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    private final MoviesGenresListDataSourceFactory moviesGenresListDataSourceFactory;

    private final SettingsManager settingsManager;

    public MoviesGenreListDataSource(String genreId, MoviesGenresListDataSourceFactory moviesGenresListDataSourceFactory,SettingsManager settingsManager){

        this.moviesGenresListDataSourceFactory = moviesGenresListDataSourceFactory;
