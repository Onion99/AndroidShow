...
import com.onion.android.databinding.PlexItemMovieBinding
import com.onion.android.kotlin.extension.getBinding
import com.onion.android.kotlin.extension.loadUrl

class MovieAdapter : BindingAdapter<Media, MovieAdapter.RelatesViewHolder>(diffUtil) {
    ...
    inner class RelatesViewHolder(val binding: PlexItemMovieBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RelatesViewHolder =
        RelatesViewHolder(parent.getBinding(R.layout.plex_item_movie))
