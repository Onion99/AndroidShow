...
public class StreamDataSource extends PageKeyedDataSource<Integer, Media> {
    ...
    private final  StreamingDataSourceFactory streamingDataSourceFactory;

    private final SettingsManager settingsManager;

    public StreamDataSource(String genreId, StreamingDataSourceFactory streamingDataSourceFactory,SettingsManager settingsManager){

        this.streamingDataSourceFactory = streamingDataSourceFactory;
